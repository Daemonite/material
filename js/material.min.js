...
DATA_TOGGLE:".floating-label .form-control"},k=function(){function e(a){b(this,e),this._element=a}return d(e,[{key:"change",value:function(b){a(this._element).val()||a(this._element).is("select")&&""!==a("option:first-child",a(this._element)).html().replace(" ","")?a(b).addClass(h.HAS_VALUE):a(b).removeClass(h.HAS_VALUE)}},{key:"focusin",value:function(b){a(b).addClass(h.IS_FOCUSED)}},{key:"focusout",value:function(b){a(b).removeClass(h.IS_FOCUSED)}}],[{key:"_jQueryInterface",value:function(b){return this.each(function(){var d=b?b:"change",f=a(this).data(c);if(f||(f=new e(this),a(this).data(c,f)),"string"==typeof d){if(void 0===f[d])throw new Error('No method named "'+d+'"');f[d](a(this).closest(j.DATA_PARENT))}})}}]),e}();return a(document).on(i.CHANGE+" "+i.FOCUSIN+" "+i.FOCUSOUT,j.DATA_TOGGLE,function(b){k._jQueryInterface.call(a(this),b.type)}),a.fn[f]=k._jQueryInterface,a.fn[f].Constructor=k,a.fn[f].noConflict=function(){return a.fn[f]=g,k._jQueryInterface},k}(jQuery),function(a){var f=".data-api",g="md.navdrawer",h="."+g,i="navdrawer",j=a.fn[i],k=292.5,l=487.5,m={BACKDROP:"navdrawer-backdrop",OPEN:"navdrawer-open",SHOW:"show"},n={breakpoint:1280,keyboard:!0,show:!0,type:"default"},o={keyboard:"boolean",show:"boolean",type:"string"},p={CLICK_DATA_API:"click"+h+f,CLICK_DISMISS:"click.dismiss"+h,FOCUSIN:"focusin"+h,HIDDEN:"hidden"+h,HIDE:"hide"+h,KEYDOWN_DISMISS:"keydown.dismiss"+h,MOUSEDOWN_DISMISS:"mousedown.dismiss"+h,MOUSEUP_DISMISS:"mouseup.dismiss"+h,SHOW:"show"+h,SHOWN:"shown"+h},q={CONTENT:".navdrawer-content",DATA_DISMISS:'[data-dismiss="navdrawer"]',DATA_TOGGLE:'[data-toggle="navdrawer"]'},r=function(){function f(c,d){b(this,f),this._backdrop=null,this._config=this._getConfig(d),this._content=a(c).find(q.CONTENT)[0],this._element=c,this._ignoreBackdropClick=!1,this._isShown=!1}return d(f,[{key:"hide",value:function(b){b&&b.preventDefault();var c=m.OPEN+"-"+this._config.type,d=a.Event(p.HIDE);a(this._element).trigger(d),this._isShown&&!d.isDefaultPrevented()&&(this._isShown=!1,this._setEscapeEvent(),a(document).off(p.FOCUSIN),a(this._content).off(p.MOUSEDOWN_DISMISS),a(this._element).off(p.CLICK_DISMISS).removeClass(m.SHOW),this._hideNavdrawer(c))}},{key:"show",value:function(b){var c=this,d=a.Event(p.SHOW,{relatedTarget:b});a(this._element).trigger(d),this._isShown||d.isDefaultPrevented()||(this._isShown=!0,a(document.body).addClass(m.OPEN+"-"+this._config.type),this._setEscapeEvent(),a(this._element).addClass(i+"-"+this._config.type),a(this._element).on(p.CLICK_DISMISS,q.DATA_DISMISS,a.proxy(this.hide,this)),a(this._content).on(p.MOUSEDOWN_DISMISS,function(){a(c._element).one(p.MOUSEUP_DISMISS,function(b){a(b.target).is(c._element)&&(c._ignoreBackdropClick=!0)})}),this._showBackdrop(),this._showElement(b))}},{key:"toggle",value:function(a){return this._isShown?this.hide():this.show(a)}},{key:"_enforceFocus",value:function(){var b=this;a(document).off(p.FOCUSIN).on(p.FOCUSIN,function(c){("default"===b._config.type||a(window).width()<=b._config.breakpoint)&&(b._element===c.target||a(b._element).has(c.target).length||b._element.focus())})}},{key:"_getConfig",value:function(b){return b=a.extend({},n,b),e.typeCheckConfig(i,b,o),b}},{key:"_hideNavdrawer",value:function(b){var c=this;this._showBackdrop(function(){a(document.body).removeClass(b),c._element.setAttribute("aria-hidden","true"),c._element.style.display="none",a(c._element).trigger(p.HIDDEN)})}},{key:"_removeBackdrop",value:function(){this._backdrop&&(a(this._backdrop).remove(),this._backdrop=null)}},{key:"_setEscapeEvent",value:function(){var b=this;this._isShown&&this._config.keyboard?a(this._element).on(p.KEYDOWN_DISMISS,function(a){27===a.which&&b.hide()}):this._isShown||a(this._element).off(p.KEYDOWN_DISMISS)}},{key:"_showBackdrop",value:function(b){var c=this,d=e.supportsTransitionEnd();if(this._isShown){if(this._backdrop=document.createElement("div"),a(this._backdrop).addClass(m.BACKDROP).addClass(m.BACKDROP+"-"+this._config.type).appendTo(document.body),a(this._element).on(p.CLICK_DISMISS,function(a){return c._ignoreBackdropClick?void(c._ignoreBackdropClick=!1):void(a.target===a.currentTarget&&c.hide())}),d&&e.reflow(this._backdrop),a(this._backdrop).addClass(m.SHOW),!b)return;if(!d)return void b();a(this._backdrop).one(e.TRANSITION_END,b).emulateTransitionEnd(l)}else if(this._backdrop&&!this._isShown){a(this._backdrop).removeClass(m.SHOW);var f=function(){c._removeBackdrop(),b&&b()};d?a(this._backdrop).one(e.TRANSITION_END,f).emulateTransitionEnd(l):f()}else b&&b()}},{key:"_showElement",value:function(b){var c=this,d=e.supportsTransitionEnd();this._element.parentNode&&this._element.parentNode.nodeType===Node.ELEMENT_NODE||document.body.appendChild(this._element),this._element.removeAttribute("aria-hidden"),this._element.style.display="block",d&&e.reflow(this._element),a(this._element).addClass(m.SHOW),this._enforceFocus();var f=a.Event(p.SHOWN,{relatedTarget:b}),g=function(){c._element.focus(),a(c._element).trigger(f)};d?a(this._content).one(e.TRANSITION_END,g).emulateTransitionEnd(k):g()}}],[{key:"_jQueryInterface",value:function(b,d){return this.each(function(){var e=a.extend({},f.Default,a(this).data(),"object"===("undefined"==typeof b?"undefined":c(b))&&b),h=a(this).data(g);if(h||(h=new f(this,e),a(this).data(g,h)),"string"==typeof b){if(void 0===h[b])throw new Error('No method named "'+b+'"');h[b](d)}else e.show&&h.show(d)})}},{key:"Default",get:function(){return n}}]),f}();return a(document).on(p.CLICK_DATA_API,q.DATA_TOGGLE,function(b){var c=this,d=e.getSelectorFromElement(this),f=void 0;d&&(f=a(d)[0]);var h=a(f).data(g)?"toggle":a.extend({},a(f).data(),a(this).data());"A"===this.tagName&&b.preventDefault();var i=a(f).one(p.SHOW,function(b){b.isDefaultPrevented()||i.one(p.HIDDEN,function(){a(c).is(":visible")&&c.focus()})});r._jQueryInterface.call(a(f),h,this)}),a.fn[i]=r._jQueryInterface,a.fn[i].Constructor=r,a.fn[i].noConflict=function(){return a.fn[i]=j,r._jQueryInterface},r}(jQuery),function(a){var b="md.controlfocus",c="."+b,d={FOCUS:"focus"},e={IS_MOUSEDOWN:!1},f={BLUR:"blur"+c,FOCUS:"focus"+c,MOUSEDOWN:"mousedown"+c,MOUSEUP:"mouseup"+c},g={CONTROL:".custom-control",INPUT:".custom-control-input"};a(document).on(""+f.BLUR,g.INPUT,function(b){a(b.target).removeClass(d.FOCUS)}).on(""+f.FOCUS,g.INPUT,function(b){e.IS_MOUSEDOWN===!1&&a(b.target).addClass(d.FOCUS)}).on(""+f.MOUSEDOWN,g.CONTROL,function(a){e.IS_MOUSEDOWN=!0}).on(""+f.MOUSEUP,g.CONTROL,function(a){setTimeout(function(){e.IS_MOUSEDOWN=!1},1)})}(jQuery),function(a){var c="md.tabswitch",f="tabswitch",g=a.fn[f],h=390,i={ANIMATE:"animate",INDICATOR:"nav-tabs-indicator",MATERIAL:"nav-tabs-material",SCROLLABLE:"nav-tabs-scrollable",SHOW:"show"},j={SHOW_BS_TAB:"show.bs.tab"},k={DATA_TOGGLE:'.nav-tabs [data-toggle="tab"]',NAV:".nav-tabs",NAV_ITEM:".nav-item"},l=function(){function f(c){if(b(this,f),"undefined"==typeof a.fn.tab)throw new Error("Material's JavaScript requires Bootstrap's tab.js");this._nav=c,this._navindicator=null}return d(f,[{key:"switch",value:function(b,c){var d=this,f=e.supportsTransitionEnd();this._navindicator||this._createIndicator();var g=a(b).closest(k.NAV_ITEM).offset().left,j=a(b).closest(k.NAV_ITEM).outerWidth(),l=a(this._nav).offset().left,m=a(this._nav).scrollLeft(),n=a(this._nav).outerWidth();if(void 0!==c){var o=a(c).closest(k.NAV_ITEM).offset().left,p=a(c).closest(k.NAV_ITEM).outerWidth();a(this._navindicator).css({left:o+m-l,right:n-(o+m-l+p)}),a(this._navindicator).addClass(i.SHOW),e.reflow(this._navindicator),f&&a(this._nav).addClass(i.ANIMATE)}a(this._navindicator).css({left:g+m-l,right:n-(g+m-l+j)});var q=function(){a(d._nav).removeClass(i.ANIMATE),a(d._navindicator).removeClass(i.SHOW)};return f?void a(this._navindicator).one(e.TRANSITION_END,q).emulateTransitionEnd(h):void q()}},{key:"_createIndicator",value:function(){this._navindicator=document.createElement("div"),a(this._navindicator).addClass(i.INDICATOR).appendTo(this._nav),a(this._nav).addClass(i.MATERIAL)}}],[{key:"_jQueryInterface",value:function(b){return this.each(function(){var d=a(this).closest(k.NAV)[0];if(d){var e=a(d).data(c);e||(e=new f(d),a(d).data(c,e)),e.switch(this,b)}})}}]),f}();return a(document).on(j.SHOW_BS_TAB,k.DATA_TOGGLE,function(b){l._jQueryInterface.call(a(b.target),b.relatedTarget)}),a.fn[f]=l._jQueryInterface,a.fn[f].Constructor=l,a.fn[f].noConflict=function(){return a.fn[f]=g,l._jQueryInterface},l}(jQuery),function(a){function b(){return{bindType:h.end,delegateType:h.end,handle:function(b){if(a(b.target).is(this))return b.handleObj.handler.apply(this,arguments)}}}function c(a){return(a[0]||a).nodeType}function d(){h=g(),a.fn.emulateTransitionEnd=f,j.supportsTransitionEnd()&&(a.event.special[j.TRANSITION_END]=b())}function e(a){return{}.toString.call(a).match(/\s([a-zA-Z]+)/)[1].toLowerCase()}function f(b){var c=this,d=!1;return a(this).one(j.TRANSITION_END,function(){d=!0}),setTimeout(function(){d||j.triggerTransitionEnd(c)},b),this}function g(){if(window.QUnit)return!1;var a=document.createElement("material");for(var b in i)if(void 0!==a.style[b])return{end:i[b]};return!1}var h=!1,i={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"},j={TRANSITION_END:"mdTransitionEnd",getSelectorFromElement:function(a){var b=a.getAttribute("data-target");return b||(b=a.getAttribute("href")||"",b=/^#[a-z]/i.test(b)?b:null),b},getUID:function(a){do a+=~~(1e6*Math.random());while(document.getElementById(a));return a},reflow:function(a){new Function("md","return md")(a.offsetHeight)},supportsTransitionEnd:function(){return Boolean(h)},triggerTransitionEnd:function(b){a(b).trigger(h.end)},typeCheckConfig:function(a,b,d){for(var f in d)if(d.hasOwnProperty(f)){var g=d[f],h=b[f],i=h&&c(h)?"element":e(h);if(!new RegExp(g).test(i))throw new Error(a.toUpperCase()+": "+('Option "'+f+'" provided type "'+i+'" ')+('but expected type "'+g+'".'))}}};return d(),j}(jQuery))}(jQuery);