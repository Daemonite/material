...
(function (global, factory) {
  ...
  var Ripplet = function () {
    ...
    addEventListener('pointerdown', function (event) {
      ...
      var currentTarget = event.target.closest('.btn, .card-link, .card-primary-action, .chip-action, .list-group-item-action, [data-ripplet]');
      ...
      } else if (cls.contains('btn-outline-light')) {
        ripplet(rippleTarget, {
          color: '#d7d7d7',
          opacity: 1
        });
