	...
	+function ($) {
		...
		$.fn.datepicker = function (options) {
			this.each(function () {
				...
				var datepickerApi = $this.pickadate('picker'),
				    datepickerApiRoot = datepickerApi.$root,
				    datepickerDisplayD = datepickerApi.get('highlight', 'd'),
				    datepickerDisplayM = datepickerApi.get('highlight', 'mmm'),
				    datepickerDisplayW = datepickerApi.get('highlight', 'dddd'),
				...
				datepickerApi.on({
					...
					render: function () {
						if (datepickerApi.get('select') === null) {
							...
							$('.picker__box', datepickerApiRoot).prepend($this.datepickerDisplay(datepickerApi.get('select', 'd'), datepickerApi.get('select', 'mmm'), datepickerApi.get('select', 'dddd'), datepickerApi.get('select', 'yyyy')));
						};
					}
				});
			});
		...
		$.fn.datepickerDisplay = function (d, m, w, y) {
			return '<div class="picker__date-display"><div class="picker__date-display-top"><span class="picker__year-display">' + y + '</span></div><div class="picker__date-display-bottom"><span class="picker__weekday-display">' + w + '</span><span class="picker__day-display">' + d + '</span><span class="picker__month-display">' + m + '</span></div></div>'
		};
	}(jQuery);
