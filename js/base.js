// modernizr v2.8.3
// #-backgroundsize-boxshadow-flexbox-flexboxlegacy-csstransforms-csstransforms3d-touch-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
...
// pickadate customise
	(function ($) {
				...
				datepickerApi.on({
					...
					open: function () {
						if (datepickerApi.get('select') === null) {
							...
							$this.datepicker.datepickerShow(datepickerApi, datepickerRoot);
						}
					},
					render: function () {
						$this.datepicker.datepickerShow(datepickerApi, datepickerRoot);
		...
		$.fn.datepicker.datepickerShow = function (datepickerApi, datepickerRoot) {
